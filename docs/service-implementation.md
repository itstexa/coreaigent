...
Each team service lives in `services/<name>/` and provides a `Dockerfile`. The local override generated by `scripts/coreaigent.ps1` builds that directory under the fixed Compose service name; callers always use `http://<name>:8080`.
